...
- The repository is public under the MIT license. The release workflow publishes the package to the public npm registry through a trusted publisher. Never store an npm token in the repository or in a secret.
